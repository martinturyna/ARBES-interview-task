...
public interface TelephoneBillCalculator {
     ...
     * @Input
     *
     * Parameter of calculate(String phoneLong) is a string representing the list of calls seperated by the end of line.
     * It is in CSV format with following fields:
     *
